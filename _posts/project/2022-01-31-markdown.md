...
<!-- 
    toc : table of content로 목차를 뜻함 
    :toc .large-only : # 붙은 Header들만 목차로 만드는 옵션 
-->
...
<under> under hello </under>


### 16. youtube
{% include components/youtubePlayer.html id='lsPN-N2ze40' %}


### 17. slick
<div class="main_center">
    <div><img src= "/assets/img/blog/example1/shoes1.jpeg" style="width: auto; height: auto;"></div>
    <div><img src="/assets/img/blog/example1/shoes2.jpeg" style="width: auto; height: auto;"></div>
    <div><img src= "/assets/img/blog/example1/shoes3.jpeg" style="width: auto; height: auto;"></div>
</div>
<script>
